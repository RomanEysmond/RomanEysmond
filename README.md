...
<h3 align="center">
Каждый день - это возможность стать лучше, я стараюсь её использовать. Это может быть написание кода, размышление над решением интересной задачи, чтение или просто отдых, как способ обновить сознание. 
Важно всё, что ты делаешь и не делаешь.</h3>
<h1 align="center">
...
<h3 align="left">Каждый из $${\color{red}pet-проектов}$$ для меня - возможность созать что-то новое, нужное и эффективное, отточить свои навыки.</h3>
<h3 align="left"> Большая часть из проектов написаны на $${\color{red}XML}$$, так как он всё ещё один самых популярных подходов, и ещё не скоро будет везде заменён на Compose.</h3>
<h3 align="left"> Часть проектов написана на $${\color{red}Compose}$$, который мне нравится больше, ибо это современно и очень удобно.</h3>
<h3 align="left"> Отдельная интересная составляющая проектов - $${\color{red}многомодульность}$$, которая заставляет корпеть над разделением по функционалу и архитектуре проект.</h3>
