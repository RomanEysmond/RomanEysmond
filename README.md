...
<h3 align="center">CodeWars - это один из способов стать лучше в рамках алгоритмического программирования и создания более эффективных решений.
...
<h3 align="center">Каждый из pet-проектов для меня - возможность созать что-то новое, нужное и эффективное, отточить свои навыки.
 ...
 Отдельная интересная составляющая проектов - многомодульность, которая заставляет корпеть над разделением по функционалу и архитектуре проекта составляющих кода.
</h3>
<h3 align="center">
